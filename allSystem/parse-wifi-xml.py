        ...
        for j in i:
            for h in j:
                ...
                if('encryption' not in dic_wf):
                    dic_wf['essid'] = 'None'
            print(dic_wf)
            print("ESSID - "+str(dic_wf['essid'])+" | BSSID - "+str(dic_wf['BSSID'])+" | CHANNEL - "+str(dic_wf['channel'])+" | ENC - 
"+str(dic_wf['encryption'])+"\n")
            filetxt.write("ESSID - "+str(dic_wf['essid'])+" | BSSID - "+str(dic_wf['BSSID'])+" | CHANNEL - "+str(dic_wf['channel'])+" | ENC - 
"+str(dic_wf['encryption'])+"\n")
            ...
            for h in j:
                ...
                if(h.tag == 'wireless-client'):
                    ...
                    if(dic_wfclient['essid'] != None):
                        print(dic_wfclient)
                        print("ESSID - "+str(dic_wfclient['essid'])+" | BSSID - "+str(dic_wfclient['BSSID'])+" | CLIENTE MAC - 
"+str(dic_wfclient['client-mac'])+" | Cliente EQP - "+str(dic_wfclient['client-manuf'])+" | Status - "+str(dic_wfclient['type'])+"\n")
                        filetxt.write("ESSID - "+str(dic_wfclient['essid'])+" | BSSID - "+str(dic_wfclient['BSSID'])+" | Cliente MAC - 
"+str(dic_wfclient['client-mac'])+" | Cliente EQP - "+str(dic_wfclient['client-manuf'])+" | Status - "+str(dic_wfclient['type'])+"\n")
